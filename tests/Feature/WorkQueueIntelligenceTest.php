...
class WorkQueueIntelligenceTest extends TestCase
{
    ...
    public function test_employee_work_screen_renders(): void
    {
        ...
        $this->actingAs($employee)
            ...
            ->assertOk()
            ->assertSee('Arafath parcel command board')
            ->assertSee('Confirmed parcels to dispatch')
            ->assertSee('Confirmed parcel list')
            ->assertSee('Refresh live queue')
            ->assertDontSee('My work dashboard')
            ...
            ->assertDontSee('Done today')
            ->assertDontSee('Waiting review')
