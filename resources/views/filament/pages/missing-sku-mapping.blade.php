    ...
    <div class="grid gap-6">
            ...
            <div class="grid gap-4 lg:grid-cols-[1fr_0.45fr] lg:items-start">
                <div>
                    ...
                    <p class="mt-2 max-w-3xl text-sm text-gray-600 dark:text-gray-300">
                        These Stock App rows arrived without a product link. Choose the correct product once and HELOS will recalculate the row and update stock movement where needed.
                    </p>
                </div>
        ...
        <x-filament::section>
            <div class="grid gap-4 md:grid-cols-[0.45fr_1fr]">
                ...
                <label class="grid gap-1 text-sm">
                    <span class="font-medium text-gray-950 dark:text-white">Find an order</span>
